...
public class VolumeTiers {
    ...
    private String discount_appl_next_period = "";
    ...
    public String getDiscount_appl_next_period() {
        return discount_appl_next_period;
    }

    public void setDiscount_appl_next_period(String discount_appl_next_period) {
        this.discount_appl_next_period = discount_appl_next_period;
    }
